    ...
    public partial class primeiraConfig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Paciente = table.Column<string>(type: "varchar(150)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Especialidade = table.Column<string>(type: "varchar(150)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBAtividades_TBMedicos", x => new { x.ListaAtividadesId, x.ListaMedicosId });
                    table.ForeignKey(
                        name: "FK_TBAtividades_TBMedicos_TBAtividade_ListaAtividadesId",
                        column: x => x.ListaAtividadesId,
                        principalTable: "TBAtividade",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TBAtividades_TBMedicos_TBMedico_ListaMedicosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TBAtividades_TBMedicos_ListaMedicosId",
                table: "TBAtividades_TBMedicos",
